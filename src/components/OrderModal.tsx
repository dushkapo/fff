...
interface OrderModalProps {
    ...
    isOpen: boolean;
    onClose: () => void;
    deliveryEnabled?: boolean; // Prop to control delivery visibility
}
...
export default function OrderModal({ product, isOpen, onClose, deliveryEnabled = true }: OrderModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        if (!/^\d{11}$/.test(formData.phone)) {
            setErrors({ phone: 'Введите номер полностью (11 цифр)' });
            return;
        }
                            ...
                            {step === 2 && (
                                <div className="space-y-6">
                                    ...
                                    {deliveryEnabled ? (
                                        ...
                                        // If delivery disabled, show only pickup
                                    ...
                                    <div>
                                        ...
                                        {/* Day and Time Selectors (like old project) */}
                                        {timeType === 'specific' && (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-xl space-y-2">
                                        <div className="flex justify-between">
                                            <span>Букет:</span>
                                            <span className="font-medium">{finalPrice.toLocaleString('ru-RU')} ₽</span>
                                        </div>
                                        {deliveryType === 'delivery' && (
                                            <div className="flex justify-between">
                                                <span>Доставка:</span>
                                        ...
                                        <div className="flex justify-between font-bold text-lg pt-2 border-t">
                                            <span>Итого:</span>
                                            <span className="text-[#1a1a1a]">{totalPrice.toLocaleString('ru-RU')} ₽</span>
                                        </div>
                                    </div>
