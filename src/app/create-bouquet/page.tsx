...
import { Menu, X, ShoppingBag, Plus, Minus, Sparkles, Phone, Clock, ArrowLeft, MapPin } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-16 bg-zinc-50">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-xl uppercase tracking-[0.2em] text-zinc-800 mb-10">{t('howItWorks')}</h2>
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        <div className="text-center p-8 bg-white rounded-lg">
                            <div className="text-4xl mb-4">🌸</div>
                            <h3 className="font-semibold text-zinc-800 mb-2">1. {t('step1Title')}</h3>
                            <p className="text-zinc-600 text-sm">{t('step1Desc')}</p>
                        </div>
                        <div className="text-center p-8 bg-white rounded-lg">
                            <div className="text-4xl mb-4">✨</div>
                            <h3 className="font-semibold text-zinc-800 mb-2">2. {t('step2Title')}</h3>
                            <p className="text-zinc-600 text-sm">{t('step2Desc')}</p>
                        </div>
                        <div className="text-center p-8 bg-white rounded-lg">
                            <div className="text-4xl mb-4">💝</div>
                            <h3 className="font-semibold text-zinc-800 mb-2">3. {t('step3Title')}</h3>
                            <p className="text-zinc-600 text-sm">{t('step3Desc')}</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-auto shadow-2xl" onClick={e => e.stopPropagation()}>
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="font-serif text-2xl text-zinc-900">{t('placeOrder')}</h2>
                            ...
                            {orderSuccess ? (
                                <div className="text-center py-8">
                                    ...
                                    <h3 className="text-xl font-semibold text-zinc-900 mb-2">{t('orderSuccess')}</h3>
                                    <p className="text-zinc-600 mb-6">{t('weWillContact')}</p>
                                    <button
