            ...
            <header className="bg-white sticky top-0 z-50 border-b border-zinc-200">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/" className="font-serif text-xl text-zinc-900 uppercase tracking-widest notranslate">
            ...
            <footer id="contacts" className="py-16 bg-zinc-900 text-white">
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-4 gap-10">
                        {/* Brand */}
                        <div>
                            <h3 className="font-serif text-2xl mb-4 notranslate">{settings?.shop_name || 'Мир Цветов'}</h3>
                        ...
                        {(settings?.delivery_price || settings?.pickup_info || settings?.delivery_info || settings?.payment_info) && (
                            <div>
                                ...
                                <ul className="space-y-2 text-zinc-400 text-sm">
                                    {settings?.delivery_price_enabled && settings?.delivery_price && <li>• Доставка — {settings.delivery_price}</li>}
                    ...
                    <div className="border-t border-zinc-800 mt-12 pt-8 text-center">
                        <p className="text-zinc-500 text-sm">
                            © 2026 <span className="notranslate">{settings?.shop_name || 'Мир Цветов'}</span>. Все права защищены.
                        </p>
                    </div>
                </div>
            </footer>
